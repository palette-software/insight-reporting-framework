...
class ReportingTest(unittest.TestCase):
    ...
    @mock.patch("reporting.maintenance")
    @mock.patch("reporting.get_next_day")
    @mock.patch("reporting.get_last_loadable_day")
    @mock.patch("reporting.get_last_loaded_day")
    @mock.patch("psycopg2.connect")
    def test_load_days(self, mock_connect, mock_last_loaded_day, mock_last_loadable_day, mock_get_next_day, mock_maintenance, mock_load_from_file):
    ...
    @mock.patch("reporting.get_last_loaded_day")
    @mock.patch("psycopg2.connect")
    def test_load_days_today_not_possible(self, mock_connect, mock_last_loaded_day, mock_last_loadable_day, mock_get_next_day, mock_maintenance, mock_load_from_file):
