[![Build Status](https://travis-ci.org/palette-software/insight-reporting-framework.svg?branch=master)](https://travis-ci.org/palette-software/insight-reporting-framework)
